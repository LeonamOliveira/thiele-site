...
export const featureMachineText: FeatureText[] = [
  ...
  },
  {
    ...
    capacity: "Tanques de 85 | 95 litros",
    productivity: "Produtividade de 3000 m²/h",
    typeEnergy: "Bateria",
    battery: "Autonomia de 4 à 5 horas",
    carousel: [
  ...
  },
  {
    ...
    href: "/",
    description:
      "A força da limpeza profissional. Produtividade de 4500 m²/h, tanques de 120L|130L e tração potente para grandes áreas e alta pressão.",
    cta: "Solicite um orçamento",
